 ...
 * which is the only file that knows entries currently live in localStorage.
 */
(function () {
    'use strict';
    ...
    async function renderLedger() {
        ...
        entries.forEach((entry, i) => {
            ...
            msg.textContent = '\u201c' + entry.message + '\u201d'; // curly quotes, textContent stays XSS-safe
    ...
    (function signForm() {
        ...
        const websiteInp = document.getElementById('gb-website'); // honeypot
